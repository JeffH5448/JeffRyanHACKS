...
APP_ID = '03c685cc'
APP_KEY = '06c191e3e62c6dfab8ea07cb8be7b8f6'
    ...
    while True:
        ...
        if decoded_objects:
            ...
            if barcode != last_barcode:  # Only process if it's a new barcode
                # if dietary_preference == "vegan" and not nutrition_info.get('is_vegan'):
                ...
                if nutrition_info:
                    ...
                    # Check dietary preference and handle vegan condition
